...
TblTransactions.Description as DESCR,TblTransactions.Date as TD, TblUsers.Surname as SN, TblTransactions.TransactionID as TI 
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
{
 ...
 echo("<tr>");
echo("<td>".$row["SN"]."</td>".' '."<td>".$row["AMT"]."</td>".' '."<td>".$row["TD"]."</td>".' '."<td>".$row["DESCR"]."</td>");
echo("<td>
<form action='updatetransactions.php' method='post' class='inputbox' >
